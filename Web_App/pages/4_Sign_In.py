...
if st.session_state["authentication_status"]:
    ...
    with col2:
        st.markdown('<p class = "dynamicfont"><strong>Age of First Sexual Intercourse:</strong> 18', unsafe_allow_html=True)
    ...
    st.text_input("Need to message your provider? Send a message here and they will respond within 48 hours:", max_chars=200, )
    st.button("Send")
